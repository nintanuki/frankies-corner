...
- **WEN WB4723T 48" Workbench** with power outlets and light (~$150-200) — nice, but no leg room, unsure of height, and the big pegboard is overkill.
- **Craftsman Mobile Worktable** — exactly the right spirit (power strip, tool/parts storage, fits a PC) but over $5,000.
